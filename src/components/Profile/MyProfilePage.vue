    ...
    <div class="left__side">
          ...
          <div class="main">
            ...
            >
              <div class="block">
                <div class="options">
                  <img
                    src="@/assets/images/main/profile__balance.svg"
                    width="24"
                    height="24"
                    alt=""
                  />
              ...
              <div class="block">
                <div class="options">
                  <img
                    src="@/assets/images/main/profile__premium_crown.svg"
                    width="24"
                    height="19"
                    alt=""
                  />
                  <p>Премиум: <span>Вкл</span></p>
                </div>
            ...
            >
              <div class="gallery__block">
                ...
                <div class="carousel__block">
                  ...
                  <div class="arrow">
                    <img
                      src="../../assets/images/main/myprofile__carousel__arrow.svg"
                      alt=""
                    />
                  </div>
                </div>
      ...
      >
        ...
        <router-link to="/account/:user/edit">
          ...
          >
            <p>
              Редактирование анкеты приведет Вас в редактирование анкетных
              данных о вас. Город, дата рождения, параметры, интересы,
              интересующие вас форматы знакомств.
            </p>
          </div>
        </router-link>
        <div
